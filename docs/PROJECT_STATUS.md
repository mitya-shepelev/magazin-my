...
| Licenses | License activation/revocation needs automated tests and audit history | High |
...
2. Add automated tests and audit history for license domain/IP edits, suspension, revocation, and reissue.
